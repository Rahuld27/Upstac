...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        //Assert
        assertNotNull(labRequestController);
        assertEquals(testRequest.requestId,labRequestController.assignForLabTest(testRequest.getRequestId()));
    ...
    public CreateLabResult getCreateLabResult(TestRequest testRequest) {
        ...
        createLabResult.getBloodPressure();
        createLabResult.getHeartBeat();
        createLabResult.getTemperature();
        createLabResult.getOxygenLevel();
        createLabResult.getComments();
        createLabResult.getResult();
